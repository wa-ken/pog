...
class HorsesControllerTest < ActionController::TestCase
  ...
  test "should create horse" do
    assert_difference('Horse.count') do
      post :create, horse: { father: @horse.father, gender: @horse.gender, mother: @horse.mother, name: @horse.name, number: @horse.number, owner: @horse.owner, reward: @horse.reward, stable: @horse.stable }
    end
  ...
  test "should update horse" do
    patch :update, id: @horse, horse: { father: @horse.father, gender: @horse.gender, mother: @horse.mother, name: @horse.name, number: @horse.number, owner: @horse.owner, reward: @horse.reward, stable: @horse.stable }
    assert_redirected_to horse_path(assigns(:horse))
  end
